...
| | |
|---|---|
| [Browsing](browsing.md) | panes, tabs, the keyboard, folder sizes |
...
| [Operations](operations.md) | compressing, renaming in bulk, the terminal, analysis, duplicates, sync, alerts |
