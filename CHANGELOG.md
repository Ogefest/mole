...
2026-09-05 #MOLE-418 Two panes on one network drive no longer crash Mole, or hang it, when they read at the same time
...
2026-09-04 #MOLE-383 A large zip archive is no longer described as a document whose author is further in
...
2026-09-04 #MOLE-380 Checking every alert no longer asks each open folder what it may do there
